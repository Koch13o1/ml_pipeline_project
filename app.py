...
def prediction_data():
    if request.method == "GET":
        ...
        if result == 0:
            return render_template("results.html", final_result="Your annual income is less than $50k:{}".format(result))
        elif result == 1:
            return render_template("results.html", final_result="Your annual income is more than $50k:{}".format(result))
