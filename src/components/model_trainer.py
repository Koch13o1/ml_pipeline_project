        ...
        try:
            ...
            param={
                ...
                "Decision Tree":{
                    ...
                    "max_features":["sqrt", "log2"] # "auto" was removed
                },
                "Logistic Regression":{
                    "class_weight": ["balanced"],
                    "penalty": ["l1", "l2"],
            ...
            # best_model_score = sorted(model_report.values())
            best_model_score = float('-inf')
            best_model_name = ""
            best_model = None
            for model, result in model_report.items():
                if result[1] > best_model_score:
                    best_model_score = result[1]
